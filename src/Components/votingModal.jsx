...
const VotingModal = ({onSubmit, handlePopupCancel}) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 px-4 h-full">
      ...
      >
        <div className="self-end cursor-pointer relative" onClick={handlePopupCancel}>
        ...
        <button className="bg-[#000] text-white font-semibold py-3 px-4 rounded relative overflow-hidden text-xl w-[100px] h-[40px] self-end font-syne flex justify-center items-center gap-2 z-[1] blackButtons"
        style={{
